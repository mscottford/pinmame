...
static
#endif
void alpha_set_level(int level) {
	if(level == 0)
		level = -1;
...
static
#endif
UINT32 alpha_blend16( UINT32 d, UINT32 s )
{
...
static
#endif
UINT32 alpha_blend32( UINT32 d, UINT32 s )
{
	const UINT8 *alphas = alpha_cache.alphas;
	const UINT8 *alphad = alpha_cache.alphad;
...
static
#endif
UINT32 alpha_blend_r16( UINT32 d, UINT32 s, UINT8 level )
{
...
static
#endif
UINT32 alpha_blend_r32( UINT32 d, UINT32 s, UINT8 level )
{
	const UINT8 *alphas = alpha_cache.alpha[level];
	const UINT8 *alphad = alpha_cache.alpha[255 - level];
	return (alphas[s & 0xff] | (alphas[(s>>8) & 0xff] << 8) | (alphas[(s>>16) & 0xff] << 16))
...
static
#endif
void sect_rect(struct rectangle *dst, const struct rectangle *src)
{
