'Last Updated in VBS v3.21
'-Added accounting reset switch (Inkochnito)
...
vpmSystemHelp = "GamePlan keys:" & vbNewLine &_
  ...
  vpmKeyName(keyHiScoreReset)& vbTab & "accounting/high score reset" & vbNewLine &_
...
Private Sub gpShowDips
	...
	vpmDips.ViewDips
End Sub
Set vpmShowDips = GetRef("gpShowDips")
Private vpmDips
